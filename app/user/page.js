...
export default function User() {
  return (
    <main className="flex min-h-screen max-w-[1440px] flex-col items-center justify-between bg-white">
      <div className="relative overflow-hidden flex flex-col min-w-full h-auto items-center bg-none gap-10 px-16 pt-24 pb-16 z-[2] shadow-container">
        <div className="w-full flex gap-12 justify-between">
          ...
          <BackgroundPath
            ...
            opacity="0.5"
          />
          <div className="w-[300px] flex flex-col gap-8 z-[2]">
            <div className="flex flex-col gap-5">
              <div className="w-[300px] h-[300px] bg-[url('/assets/images/user-img.jpg')] bg-cover rounded-3xl shadow-card"></div>
              <div className="flex flex-col gap-2">
                <h3 className="font-ebgaramond font-semibold text-3xl text-brown text-center tracking-wide capitalize">
                  isabella rodriguez
                </h3>
                <p className="font-opensans font-semibold text-base text-brown text-center tracking-wider">
                  @BakeWithBella
                </p>
              </div>
              <div className="flex gap-6 justify-center items-center">
                ...
                <svg width="8" height="15" viewBox="0 0 11 20" fill="none">
                  <path
              ...
              <p className="font-opensans font-normal text-base text-brown text-center leading-8 tracking-wider">
                Baking is not just about creating recipes; it`s about sharing
                love, one slice at a time
              </p>
            </div>
            <div className="flex flex-col gap-4">
              <h3 className="font-ebgaramond font-semibold text-3xl text-brown tracking-wide capitalize">
                recent posts
              </h3>
              <BlogCard type="profile" postName="Behind the Scenes" />
              <BlogCard
                type="profile"
                postName="Seasonal Inspirations: Fall Delights"
              />
              <BlogCard
                type="profile"
                postName="Flavorful Explorations: Citrus Infusions"
              />
            </div>
          </div>
          <div className="flex flex-col flex-1 items-center gap-12">
            <div className="flex flex-col max-w-[650px] gap-5">
              <h3 className="font-ebgaramond font-semibold text-3xl text-brown tracking-wide capitalize">
                recent recipes
              </h3>
